...
<%
	...
	List<PostVO> postList = postService.getByMemberId(member_id, "生活");
	pageContext.setAttribute("postList", postList);
	MemberVO member = mbSvc.getOne(member_id);
	pageContext.setAttribute("member", member);

	List<PostVO> list1 = postService.getFifthCreateTime("生活", member_id);
  ...
  pageContext.setAttribute("postContents1", postContents1);
	...
	List<PostVO> list2 = postService.getFifthPostLike("生活", member_id);
