...
<%
	...
	String post_class = postVO.getPost_class();
    PostService service = new PostService();
    List<PostVO> list = service.getByPostClass(post_class);
    pageContext.setAttribute("list", list);
%>

<html>
<head>
<title>某個分類的文章資料 - listAllByClass.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>某個分類的文章資料 - listAllByClass.jsp</h3>
		...
		<tr>
			...
			<td>
			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Post/Post.do" style="margin-bottom: 0px;">
			     ...
			     <input type="hidden" name="post_class"  value="${postVO.post_class}">
