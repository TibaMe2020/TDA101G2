...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/front-end/blog/css/HomePage.css">
<script defer
...
// 	String member_id = "MB00001";
	...
	pageContext.setAttribute("list", postList);
		...
		<div class="row">
			...
			<div class="col-2 padding_left">
				...
				<div class="post_class">
					...
					<ul class="categories">
						<li style="border-bottom: 1px solid #13406A;"><a
							class="a_tag"
							href="<%=request.getContextPath()%>/front-end/blog/HomePage.jsp"
							style="text-decoration: none; color: #13406A;">全部</a></li>
						<li style="border-bottom: 1px solid #13406A;"><a
							class="a_tag"
							href="<%=request.getContextPath()%>/front-end/blog/Life.jsp"
							style="text-decoration: none; color: #13406A;">生活</a></li>
						<li style="border-bottom: 1px solid #13406A;"><a
							class="a_tag"
							href="<%=request.getContextPath()%>/front-end/blog/Shopping.jsp"
							style="text-decoration: none; color: #13406A;">購物</a></li>
						<li style="border-bottom: 1px solid #13406A;"><a
							class="a_tag"
							href="<%=request.getContextPath()%>/front-end/blog/Food.jsp"
							style="text-decoration: none; color: #13406A;">美食</a></li>
						<li style="border-bottom: 1px solid #13406A;"><a
							class="a_tag"
							href="<%=request.getContextPath()%>/front-end/blog/Travel.jsp"
							style="text-decoration: none; color: #13406A;">旅遊</a></li>
						<li><a class="a_tag"
							href="<%=request.getContextPath()%>/front-end/blog/Others.jsp"
							style="text-decoration: none; color: #13406A;">其他</a></li>
					</ul>
				</div>
				...
				<div class="recommend_blogger">
					...
					<div class="each_recommend_blogger">
						...
						<span class="nickname"> <a class="a_tag" href="#"
							style="text-decoration: none; color: #13406A;">噢!兔子</a>
						</span>
					</div>
					<div class="each_recommend_blogger">
						<figure class="recommend_figure">
							<img class="recommend_blogger_picture"
								src="https://images.669pic.com/element_banner/41/83/83/73/c95ce96fa9002df8623201c605601bef.jpg">
						</figure>
						<span class="nickname"> <a class="a_tag" href="#"
							style="text-decoration: none; color: #13406A;">我愛馬卡龍</a>
						</span>
					</div>
					<div class="each_recommend_blogger">
						<figure class="recommend_figure">
						...
						<span class="nickname"> <a class="a_tag" href="#"
							style="text-decoration: none; color: #13406A;">蘇太太</a>
						</span>
					</div>
						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form id="insertform" action="<%=request.getContextPath()%>/Post/Post.do"
										class="post" method="POST" enctype="multipart/form-data" onclick="return false">
						...
						<div class="each_post" id="${postVO.post_id}">	
							...
							<div class="carousel slide" id="carousel-demo${postVO.post_id}">
								<ol class="carousel-indicators">
									<li data-target="#carousel-demo${postVO.post_id}"
							...
							<div class="post_functions">
								...
								<div class="post_share">
									...
									<br> <span class="post_share_count">${postVO.post_share}</span>
								</div>
							</div>
