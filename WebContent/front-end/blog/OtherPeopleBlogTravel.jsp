...
// 		System.out.println("別人的member_id:" + other_member_id);
		...
		List<PostVO> list = postService.getByMemberId(other_member_id, "旅遊");
		pageContext.setAttribute("list", list);

		List<PostVO> list1 = postService.getFifthCreateTime("旅遊", other_member_id);
		...
		List<PostVO> list2 = postService.getFifthPostLike("旅遊", other_member_id);
