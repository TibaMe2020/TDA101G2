...
<body class="body">
	...
	<%
		...
		List<PostVO> list = postService.getByMemberId(other_member_id, "其他");
		pageContext.setAttribute("list", list);

		List<PostVO> list1 = postService.getFifthCreateTime("其他", other_member_id);
		...
		List<PostVO> list2 = postService.getFifthPostLike("其他", other_member_id);
