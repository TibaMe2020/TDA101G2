...
<body class="body">
	...
	<%
		...
		List<PostVO> postList = postService.getByPostClass("其他");
		...
		List<PostVO> list1 = postService.getFifthCreateTime("其他");
		...
		List<PostVO> list2 = postService.getFifthPostLike("其他");
