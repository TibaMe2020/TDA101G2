...
<body class="body">
	...
	<%
		...
		List<PostVO> postList = postService.getByPostClass("生活");
		...
		List<PostVO> list1 = postService.getFifthCreateTime("生活");
		...
		List<PostVO> list2 = postService.getFifthPostLike("生活");
