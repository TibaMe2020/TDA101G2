...
<%
	...
	List<PostVO> postList = postService.getByMemberId(member_id, "美食");
	pageContext.setAttribute("postList", postList);
	MemberVO member = mbSvc.getOne(member_id);
	pageContext.setAttribute("member", member);

	List<PostVO> list1 = postService.getFifthCreateTime("美食", member_id);
  ...
  pageContext.setAttribute("postContents1", postContents1);
	...
	List<PostVO> list2 = postService.getFifthPostLike("美食", member_id);
