...
<%-- 	<%Integer total = NpoSvc.findByDonationMoney(npo_infoVO.npo_id); %> --%>
        <li class="cards_item">
          <div class="card">
            <a class="imageLink" href="<%=request.getContextPath()%>/Npo/DBGifReader2?npo_id=${npo_infoVO.npo_id}" title="Dog data">
              <img class="imgin" src="<%=request.getContextPath()%>/Npo/DBGifReader2?npo_id=${npo_infoVO.npo_id}" alt="${npo_infoVO.npo_description}">
            </a>
            <div class="card_content">
              <h2 class="card_title">${npo_infoVO.npo_name}</h2>
