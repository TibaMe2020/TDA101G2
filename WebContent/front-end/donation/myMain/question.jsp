...
.acc { .dl { box-shadow:0020pxrgba(0, 0, 0, 0.2); &:after { content:"";
	display: block;
	height: 1em;
	width: 100%;
...
.qa-container {
	height: 800px;
	background-image: linear-gradient(135deg, rgba(155, 89, 182, 0.8) 0%,
		rgba(211, 84, 0, 0.8) 100%),
		url("https://i.epochtimes.com/assets/uploads/2019/12/pets-3715733_1280-600x400.jpg");
	background-image: linear-gradient(rgba(255, 192, 203, 0.8) 0%,
		rgba(135, 206, 235, 0.7) 70%),
		url("https://i.epochtimes.com/assets/uploads/2019/12/pets-3715733_1280-600x400.jpg");
	background-repeat: no-repeat;
	background-position: center center;
	background-attachment: fixed;
...
.acc_title {
	...
	color: black;
	text-decoration: none;
	border-bottom: 1px solid #258cd1; &: before { content : "+";
	font-size: 1.5em;
	line-height: 0.5em;
	float: left;
...
<body>
	...
	<div class="qa-container">
		<div class="container-fluid d-flex align-items-center" style="height:80px; padding-left: 100px!important;">
			<div class="row">
				<i class="fas fa-bone"></i> <a
					href="<%=request.getContextPath()%>/front-end/donation/myMain/donation.jsp">公益首頁</a><span>
					> Q&A問題專區</span>
			</div>
		</div>
		<div class="container">
			...
			<div class="acc">
				<dl>
					<dt class="dt1">
						<a class="acc_title" href="#">🔍 Q1 如果沒有信用卡想捐贈怎麼辦 ? </a>
					</dt>
					<dd class="acc_panel acc_panel_col">
						<p>那就先不要捐,等有信用卡的時候再捐</p>
					</dd>
					<dt class="dt1">
						<a href="#" class="acc_title">🔍 Q2 我捐款了,但我沒有會員,可以知道自己的捐款紀錄嗎 ?</a>
					</dt>
					<dd class="acc_panel acc_panel_col">
						<p>點選公益首頁的選單,有個捐款查詢,輸入捐款人姓名與電話號碼,則可查詢自己的捐款紀錄</p>
					</dd>
					<dt class="dt1">
						<a href="#" class="acc_title">🔍 Q3 如果捐款資料填錯地址或是電話該怎麼辦 ?</a>
					</dt>
					<dd class="acc_panel acc_panel_col">
						<p>可以點選右下角的客服人員中心,他們會解決你的問題</p>
					</dd>
					<dt class="dt1">
						<a class="acc_title" href="#">🔍 Q4 會員在公益這方面有提供什麼功能 ? </a>
					</dt>
					<dd class="acc_panel acc_panel_col">
						<p>會員在捐款的時候能紀錄資料在會員中心,所捐贈的公益團體發表募款成果時也會被通知</p>
					</dd>
				</dl>
			</div>
		</div>
	...
	<script
		src="<%=request.getContextPath()%>/front-end/donation/JS/test3.js"></script>
</body>
</html>