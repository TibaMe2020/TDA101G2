	...
	<div class="container bc" >
					...
					<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/AdoptForm/adoptform.do" name="form1" novalidate>
						<div class="divforp">
							<div class="form-group">
          						...
          						<input type="TEXT" name="adopt_id" value="${adopt_infoVO.adopt_id}" readonly="readonly" class="form-control" style="border-style: none">
        					</div>
							<div class="form-row">
						    <div class="col">
						     <label>認養人姓名</label><input type="text" class="form-control" name="adopt_person"><span class="error">${errors.adopt_person}</span>
						    </div>
						    <div class="col">
						   <label>付款人姓名</label><input type="text" class="form-control" name="payadopt_person"><span class="error">${errors.payadopt_person}</span>
						    </div>
						  </div>
						  <div class="form-row">
						    <div class="col">
						     <label>聯絡電話</label><input type="text" class="form-control" name="adopt_phone_num"><span class="error">${errors.adopt_phone_num}</span>
						    </div>
						    <div class="col">
						   <label>電子信箱</label><input type="text" class="form-control" name="adopt_email"  aria-describedby="emailHelp"><span class="error">${errors.adopt_email}</span>
						    </div>
						  </div>
        ...
        <div class="col-sm-10">
          <div class="form-check">
            <input class="form-check-input" type="radio" name="adopt_payment" id="gridRadios1" value="信用卡" checked>
  ...
  <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
                     ...
                     <div class="back">
                         <svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                             ...
                             C707.1,246.4,704.4,249.1,701.1,249.1z" />
                                 ...
                                 <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">John</text>
                             </g>
                         </svg>
                     </div>
                 </div>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="adopt_payment" id="gridRadios2" value="paypal">
            <label class="form-check-label" >
             paypal
            </label>
          </div>
		...
		<div class="form-group f1">
         <label class="ladd">住家地址:</label>
         <input type="text" class="form-control" name="address"><span class="error">${errors.address}</span>
       </div>
	    
	    <div class="form-group">
         <label class="lt">想說的話:</label>
         <textarea placeholder="無" name="adopt_talk"></textarea>
       </div>
