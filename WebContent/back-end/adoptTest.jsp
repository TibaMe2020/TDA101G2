            ...
            <div class="table-title">
              <div class="row">
                <div class="col-6 text-left d-flex align-items-center">
                  <h2 id="table-title-text">動物認養</h2>
                </div>
                ...
                <tr>
                  <th>
                    <div class="d-flex justify-content-center">
                      <a href="#" class="d-flex align-items-center">認養動物編號<i class="fas fa-sort"></i></a>
                    </div>
                  </th>
                  <th>
                    <div class="d-flex justify-content-center">
                      <a href="#" class="d-flex align-items-center">認養動物名稱<i class="fas fa-sort"></i></a>
                    </div>
                  </th>
                  <th>
                    <div class="d-flex justify-content-center">
...
<!--                   <th>移除</th> -->
              ...
              <tbody id="product-table">
                ...
                <tr>
                  <td>${adopt_infoVO.adopt_id}</td>
                  <td>${adopt_infoVO.adopt_name}</td>
                  <td>${adopt_infoVO.create_time}</td>
<!--                   <td> -->
<!--                     <div class="d-flex justify-content-center"> -->
...
<!--                       </a> -->
<!--                     </div> -->
 			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Adopt/adopt.do" style="margin-bottom: 0px;">
			     <input type="submit" value="修改">
			     <input type="hidden" name="adopt_id"  value="${adopt_infoVO.adopt_id}">
...
<!--                   </td> -->
	...
	<tr>
		<td>認養動物姓名:</td>
		<td><input type="TEXT" name="adopt_name" size="45" 
			 value="<%= (adopt_infoVO==null)? "" : adopt_infoVO.getAdopt_name()%>"/><span class="error">${errors.adopt_name}</span></td>
	</tr><br><br>
	<tr>
		<td>圖片:</td>
		<td><input type="file" name="adopt_image" size="45" id="the_file"/></td>
...
<%-- 		<td><img id="blah" alt="your image" src="<%=request.getContextPath()%>/Npo/DBGifReader2?npo_id=${npo_infoVO.npo_id}"></td>		 --%>
	...
	<tr>
		<td>認養動物介紹:</td>
		<td><input type="TEXT" name="adopt_description" size="45"
			 value="<%= (adopt_infoVO==null)? "" : adopt_infoVO.getAdopt_description()%>" /><span class="error">${errors.adopt_description}</span></td>
	</tr>
	<br>
	<tr>
		<td>認養金額:</td>
		...
		<td><input class="inputmoney" type="TEXT" name="adopt_money" size="45" oninput = "value=value.replace(/[^\d]/g,'')"
			 value="<%= (adopt_infoVO==null)? "0" : adopt_infoVO.getAdopt_money()%>" /><span class="error">${errors.adopt_money}</span></td>
	</tr>
                </div>
