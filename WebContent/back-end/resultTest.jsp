            ...
            <div class="table-title">
              <div class="row">
                <div class="col-6 text-left d-flex align-items-center">
                  <h2 id="table-title-text">捐款成果</h2>
                </div>
                ...
                <tr>
                  <th>
                    <div class="d-flex justify-content-center">
                      <a href="#" class="d-flex align-items-center">公益團體成果編號<i class="fas fa-sort"></i></a>
                    </div>
                  </th>
                  <th>
                    <div class="d-flex justify-content-center">
                  ...
                  <th>
                    <div class="d-flex justify-content-center">
                      <a href="#" class="d-flex align-items-center">月份<i class="fas fa-sort"></i></a>
                    </div>
                  </th>
                    <th>
                    <div class="d-flex justify-content-center">
...
<!--                     </div> -->
        ...
        <div id="add-product" class="modal fade">
          <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
	<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Result/result.do" name="form1" enctype="multipart/form-data">             
                <div class="modal-body">
	<tr>
		<td>月份:</td>
<%-- 		<td><input type="TEXT" name="result_month"size="45" ><span class="error">${errors.result_month}</span></td> --%>
<!-- 	</tr><br><br> -->
	<td><select size="1" name="result_month">
	...
	<tr>
		<td>圖片:</td>
		<td><input type="file" name="result_image" size="45" id="the_file"/></td>	
    	<ul class="picture_list" id="pc"></ul>
	</tr>

	<tr>
		<td>公益成果內容:</td>
		<td><input type="TEXT" name="result_content" size="45"
			 /><span class="error">${errors.result_content}</span></td>
	</tr>
	
			<td>公益團體名稱:<font color=red><b>*</b></font></td>
		<td><select size="1" name="npo_id">
			<c:forEach var="npo_infoVO" items="${npoSvc.all}">
				<option value="${npo_infoVO.npo_id}"${(donation_resultVO.npo_id==npo_infoVO.npo_id)? 'selected':'' }>${npo_infoVO.npo_name}
			</c:forEach>
		</select>
		</td>
	</tr>
...
<%-- 	<%@ include file="footer.file"%> --%>
  ...
  <script src="<%=request.getContextPath()%>/front-end/member/js/productList.js"></script>
	<script>
