...
public abstract class StoreDAO implements StoreDAO_interface {
	...
	public void insert(StoreVO storeVO) {
		...
		try {
			...
			ps.setString(2, storeVO.getMember_id());
			ps.setString(3, storeVO.getStore_class());
			ps.setString(4, storeVO.getStore_name());
			ps.setString(5, storeVO.getStore_adress());
			ps.setString(6, storeVO.getStore_phone_number());
			ps.setString(7, storeVO.getStore_introduction());
			ps.setObject(8, storeVO.getStore_clicks(), java.sql.Types.INTEGER);
			ps.setObject(9, storeVO.getStore_firstbreak(), java.sql.Types.INTEGER);
			ps.setObject(10, storeVO.getStore_secondbreak(), java.sql.Types.INTEGER);
			ps.setString(11, storeVO.getStore_openhours1());
			ps.setString(12, storeVO.getStore_openhours2());
