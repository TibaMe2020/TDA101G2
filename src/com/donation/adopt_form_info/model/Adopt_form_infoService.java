...
public class Adopt_form_infoService {
	...
	public Adopt_form_infoVO addAdopt_form(String adopt_id, String adopt_person, String adopt_talk,
			String payadopt_person, String adopt_phone_num, String adopt_payment, String adopt_certificate,
			String adopt_email, String address, String member_id) {
	...
	public void insertAdopt_form(Adopt_form_infoVO adopt_form_infoVO) {
		dao.insert(adopt_form_infoVO);
